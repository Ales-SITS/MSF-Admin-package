                          ...
                          libraries.map((lib,idx)=>
                            <li key={idx} className={`${styles.itemBoxTop} ${styles.itemBoxTopSmall}`}>
                                    <div className={styles.itemBoxTopLeft}>
                                        ...
                                        <a className={`${styles.itemBoxSiteLink} ${styles.itemBoxSiteLinkSmall}`} href={`https://${host}${lib.url}`} title={`Go to ${site}${lib.url}`}>{lib.name}</a>
                                    </div>
                      ...
                      <ul>
                        {
                          ...
                          <div className={styles.itemBoxTopLeft}>
                              ...
                              <a className={`${styles.itemBoxSiteLink} ${styles.itemBoxSiteLinkSmall}`} href={`https://${host}${list.url}`} title={`Go to ${site}${list.url}`}>{list.name}</a>
                          </div>
                          <div className={styles.itemBoxTopRight}>
