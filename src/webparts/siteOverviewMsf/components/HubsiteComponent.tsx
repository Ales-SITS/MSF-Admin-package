        ...
        <div>
              <div className={styles.siteBoxTop}>
                    ...
                    <div className={substyles.subSiteBoxBottom}>
                      <a href={`${hubsite.SPWebUrl}/_layouts/15/settings.aspx`} title="Subsite Settings"><Icon iconName="Settings"/></a>
                      <a href={`${hubsite.SPWebUrl}/_layouts/15/user.aspx`} title="Subsite Permissions"><Icon iconName="SecurityGroup"/></a>
                      <a href={`${hubsite.SPWebUrl}/_layouts/15/viewlsts.aspx?view=14`} title="Subsite Content"><Icon iconName="AllApps"/></a> 
                      <a href={`${hubsite.SPWebUrl}/_layouts/15/siteanalytics.aspx?view=19`} title="Subsite Usage"><Icon iconName="LineChart"/></a> 
